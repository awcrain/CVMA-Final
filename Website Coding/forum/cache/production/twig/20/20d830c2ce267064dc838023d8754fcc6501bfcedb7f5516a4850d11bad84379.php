...
class __TwigTemplate_1c029bd30e4f3c3b0b1cd709e7c507307c046aabcb4155a2a1bfda6a2e741bb5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["custom_tags"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["custom_tags"], "BBCODE_ID", [], "any", false, false, false, 47);
            echo ")\" title=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["custom_tags"], "BBCODE_HELPLINE", [], "any", false, false, false, 47), "html_attr");
            echo "\" />
\t";
        }
        $_parent = $context['_parent'];
