...
class __TwigTemplate_5f73401b91fb07196fe92d4619d4ccba8022a300a82c9e666322d4b64e12025b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["custom_tags"]) {
                ...
                echo twig_get_attribute($this->env, $this->source, $context["custom_tags"], "BBCODE_ID", [], "any", false, false, false, 99);
                echo ")\" title=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["custom_tags"], "BBCODE_HELPLINE", [], "any", false, false, false, 99), "html_attr");
                echo "\">
\t\t";
                // line 100
