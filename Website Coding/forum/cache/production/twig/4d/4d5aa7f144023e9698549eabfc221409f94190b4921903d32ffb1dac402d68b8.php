...
/* acp_help_phpbb.html */
class __TwigTemplate_4ec31c440a9cabf4d41541199aa21b5a10dbec43d7e8391a00c29a648fab29aa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["providers"]) {
            ...
            echo "\t\t\t\t";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["providers"], "values", [], "any", false, false, false, 58));
            foreach ($context['_seq'] as $context["_key"] => $context["values"]) {
                // line 59
                echo "\t\t\t\t\t<input type=\"hidden\" name=\"";
                echo twig_get_attribute($this->env, $this->source, $context["providers"], "NAME", [], "any", false, false, false, 59);
                echo "[";
                echo twig_get_attribute($this->env, $this->source, $context["values"], "KEY", [], "any", false, false, false, 59);
                echo "]\" value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["values"], "VALUE", [], "any", false, false, false, 59);
                echo "\" />
\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
";
        ...
        $this->loadTemplate("overall_footer.html", "acp_help_phpbb.html", 67)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
    ...
    {
        return array (  226 => 67,  217 => 62,  211 => 61,  198 => 59,  193 => 58,  189 => 57,  183 => 54,  176 => 50,  171 => 48,  167 => 47,  163 => 45,  158 => 44,  153 => 42,  146 => 38,  138 => 35,  131 => 30,  124 => 28,  115 => 25,  111 => 24,  108 => 23,  104 => 22,  100 => 21,  97 => 20,  93 => 19,  84 => 15,  78 => 12,  74 => 11,  71 => 10,  66 => 9,  59 => 7,  54 => 5,  49 => 2,  37 => 1,);
    }
